...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadButtonText$$$(shuffleTreasuresButton, this.$$$getMessageFromBundle$$$("lang", "generate"));
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 0;
        gbc.anchor = GridBagConstraints.WEST;
        ...
        this.$$$loadButtonText$$$(permutateTreasuresButton, this.$$$getMessageFromBundle$$$("lang", "shuffle"));
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        ...
        this.$$$loadButtonText$$$(shuffleDistancesButton, this.$$$getMessageFromBundle$$$("lang", "generate"));
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        ...
        this.$$$loadButtonText$$$(permutateDistancesButton, this.$$$getMessageFromBundle$$$("lang", "shuffle"));
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
